...
class Student (models.Model):
    ...
    ensemble = models.CharField(max_length=9, choices=ENSEMBLES)
    ...
    dietary_needs = models.CharField(max_length=20, choices=MEALS)
    years_tenure = models.CharField(max_length=3, choices=YEARS)
    senior_ceremonies = models.BooleanField()
    gender = models.CharField(max_length=6, choices=GENDERS)
    shoe_size = models.CharField(max_length=2, choices=SHOE_SIZES)
    tshirt_size = models.CharField(max_length=6, choices=TSHIRT_SIZES)
